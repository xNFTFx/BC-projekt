...
namespace bc.Controllers
{
    public class ProduktsController : Controller
    {
        ...
        public ProduktsController(DatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProduktu,NazwaProduktu")] Produkt produkt)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProduktu,NazwaProduktu")] Produkt produkt)
        {
