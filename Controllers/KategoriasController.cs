...
namespace bc.Controllers
{
    public class KategoriasController : Controller
    {
        ...
        public KategoriasController(DatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdKategorii,Name")] Kategoria kategoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdKategorii,Name")] Kategoria kategoria)
        {
